...
- 임의의 주어진 자료에 대해 그에 맞는 최고의 기법을 선택하는 것이 중요
...
우리는 expected test MSE를 ![math](https://latex.codecogs.com/gif.latex?E[y_{0}-\hat{f}(x_{0})]^{2})와 같이 정의할 수 있고, 이는 다음과 같이 나타낼 수 있다.
